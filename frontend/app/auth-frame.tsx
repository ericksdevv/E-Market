    ...
    <main className="auth-page">
      <section className="auth-showcase">
        ...
        <Image
          ...
          alt="Mercado com frutas, legumes e produtos frescos"
          fill
          priority
        ...
        <div className="auth-showcase-copy">
          <span className="auth-copy-badge">Seu mercado online</span>
          <h1>
            Seu mercado
            <br />
            na palma da mão.
          </h1>
          <p>Compre com praticidade, receba no conforto da sua casa.</p>
      ...
      <section className="auth-form-side">
        <button className="auth-theme" type="button" aria-label="Modo escuro">
          ◐ Modo escuro
        </button>
